describe('Покупка аватара', function () {                                // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get(':nth-child(1) > .auth__input').type('Login');                   // вводим логин
         cy.get('#password').type('password');               // вводим пароль
         ...
         cy.get('.pay__input-box-last-of > .pay_base-input-v2').type('GERMAN DOLNIKOV');                           // вводим имя владельца действия карты
